...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  const fallbackReplies = [
    ...
    "সুমন স্যার দেখেন না আমারে বট বলে😭 আমি মাদ্রাসায় পড়ি বলে গালি দিলাম না বেবি বল সময় আছে 😡?",
    "I love you baby meye hole chipay aso",
    "বট না বলে বেবি বলো আড্ডা দেবো😘",
    ...
    "তুই বট তোর নানি বট তো চৌদ্দগুষ্টি বট😈😒",
    "তুমি কি আমাকে ডাকলে বন্ধু 🤖?",
    "আমারে না রাগিয়ে যাও পড়তে বসো 🖤🫶",
    "Hi, 🤖 i can help you~~~~"
  ];
